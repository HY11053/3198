...
<div class="header">
    <div class="top">
        <div class="inner">
            <div class="top_l"> 欢迎您来到3198创业致富网！ 今日新增商机<a href="/latestxm"><span>0个</span></a> 发布资讯<a
                    href="/latestnew"><span>0条</span></a>
        ...
        <div class="header_box">
            ...
            <div class="search">
                <div class="search_box">
                    <form id="search_form" action="http://www.3198.com/search" target="_blank" method="get">
                        <input type="text" onblur="if (this.value == '') {this.value = this.attributes['def'].value;this.className='search_input';}"  onfocus="if (this.value == this.attributes['def'].value) {this.value='';this.className='search_input1';}"  def="想找什么项目？" class="search_input" value="想找什么项目？" name="key">
            ...
            <div id="js_bn" class="bn">
                ...
                <div class="bd">
                    <ul>
                        <li><a href="/myyp" target="_blank"><img src="/public/images/myjmd.jpg" width="220" height="64" alt=""/></a></li>
                        <li><a href="/myyp/223" target="_blank"><img src="/public/images/yyjm.jpg" width="220" height="64" alt=""/></a></li>
                        <li><a href="/cyms/2" target="_blank"><img src="/public/images/tsxc.jpg" width="220" height="64" alt=""/></a></li>
                    </ul>
                </div>
            </div>
            <!--幻灯片 结束-->
...
<div class="footer">
    <div class="footer_nav">
        <a href="/about.html">关于我们</a>　|　<a href="/sitemap.html">网站地图</a>　|　<a href="/copyright.html">法律声明</a>　|　<a href="/contact.html">联系我们</a>
    </div>
    ...
    <div class="copyright">
        ...
        <div style="width:300px;margin:0 auto; padding:20px 0;">
            <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31011302003783" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;">
                <img src="/public/images/ba.png" style="float:left;"/>
                <p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;">沪公网安备 31011302003783号</p></a>
        </div>
    </div>
</div>
<!--footer结束--><!--footer结束-->
