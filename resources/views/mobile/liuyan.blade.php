<div id="phone-model" class="clearfix">
    <div class="phone-modelbox">
        ...
        <form onsubmit="return false;">
            <input type="hidden" name="project_id" id="project_id" value="43790">
            <input type="hidden" name="cid" id="cid" value="1">
            <input type="hidden" name="title" id="fm_title" value="小鱼儿酸菜鱼加盟">
            <input type="hidden" name="cla" id="cla" value="酸菜鱼">
            <input type="hidden" name="combrand" id="combrand" value="小鱼儿酸菜鱼加盟">
            <div class="inputbox">
...
<div class="popup_mask" style="visibility: visible; display: none;">
    ...
    <div class="CengBox">
        ...
        <form class="modalbox" onsubmit="return false">
            <input type="hidden" name="msg_project_id" id="msg_project_id" value="43790">
            <input type="hidden" name="msg_cid" id="msg_cid" value="1">
            <input type="hidden" name="msg_fm_title" id="msg_fm_title" value="小鱼儿酸菜鱼加盟">
            <input type="hidden" name="msg_cla" id="msg_cla" value="酸菜鱼">
            <input type="hidden" name="msg_combrand" id="msg_combrand" value="小鱼儿酸菜鱼加盟">
