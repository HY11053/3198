...
@section('main_content')
    ...
    <div class="list_middle">
        ...
        <div class="a_content">
            <p>1、3198创业商机网所提供的项目、资讯等相关信息，内容大多来自互联网或者由商家直接提供，其所涉及的项目、商品、联络信息等，商家对其真实性承担责任。如若您认为本网站网页的相关内容，侵害到您的合法权益，您应及时联系本网站，并提供相关证明（如身份证明、权属证明等），本网站将及时删除涉嫌侵权的内容。</p>

            <p>2、本网站（除商家提供的项目信息外）版权属于上海佐赛网络科技有限公司所有，未经允许，任何企业、网站以及个人不得擅自使用。经过授权使用作品的，应在授权使用范围内使用，并注明来源于“3198创业商机网”，违者本网站将有权追究法律责任。</p>
